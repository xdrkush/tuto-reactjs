...
export const getArticles = (data) => {
  return (dispatch) => {
    ...
    return axios.get("http://localhost:3030/api/article")
      .then((res) => {
...
export const getArticleID = (id) => {
  return (dispatch) => {
    console.log('reducers get article')
    return axios.get(`http://localhost:3030/api/article/${ id }`)
      .then((res) => {
...
export const createArticle = (data) => {
  return (dispatch) => {
    return axios.post("http://localhost:3030/api/article", data)
      .then((res) => {
...
export const deleteArticle = (id) => {
  return (dispatch) => {
    return axios.delete(`http://localhost:3030/api/article/${ id }`)
      .then((res) => {
...
export const editArticle = (data) => {
  return (dispatch) => {
    return axios.put(`http://localhost:3030/api/article/${ data.id }`, data)
      .then((res) => {
